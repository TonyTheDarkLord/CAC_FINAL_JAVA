...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    ...
	    <!-- </form> -->
	    <div id="iconosBarra" style="position:absolute;right: 48px;"><a href="carrito.jsp" style="position:relative;">
				...
				<div class="wrapper row" style="padding:20px">
					...
					<div class="col-md-6">
						...
						<div style="padding-bottom: 10px;">
							<h3><span>$ <%=String.format(Locale.ROOT, "%.2f", prod.getPrecio())%></span></h3>
						</div>
						<div style="padding-bottom: 50px;">
							<%	if(prod.getStock()!=0){%>
								<h5 id="h5cant"><span style="display:flex;">Cantidad:
					        	<select class="form-control" id="cantidad" style="max-width: fit-content;margin-left: 20px;">
					        	<%
								...
								<div>
									<button id="btnCompra" class="btn btn-primary btn-lg btn-block" onClick="addToCart(<%= prod.getId() %>)" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'</i> Processing Order" type="button">Añadir al carrito</button>
								</div>
					        	<%
					        } else {
					        	 %>	
									...
									<div>
										<button id="btnCompra" class="btn btn-primary btn-lg btn-block" type="button" disabled>SIN STOCK</button>
									</div>
						          <%
					        }
					        %>
	          		...
	          		for(Producto rel: prodsRel){
	          			%>
	          			     <div class="card">
						        ...
						        <div class="card-body">
							      <h5><a href="producto.jsp?id=<%= rel.getId() %>"><%= rel.getNombre() %></a></h5>
							      <p class="card-text">$ <%=String.format(Locale.ROOT, "%.2f", rel.getPrecio())%></p>
							    </div>
